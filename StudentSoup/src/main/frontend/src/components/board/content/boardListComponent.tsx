    ...
    <div className="my-[15px]">
      <div className="bg-white p-[11px] rounded-[5px] border border-solid border-[#bcbcbc]">
        <table className="w-full text-center">
          ...
          <tbody>
            <tr className="bg-[#F3F3F3] text-[#FF611D] py-[15px] px-[13px] border-b-[1px] border-solid border-[#BCBCBC]">
              <td className="text-start py-[15px] px-[13px] border-l-[4px] border-solid border-[#FF611D]">
                [공지] 게시판 커뮤니티 이용 안내
              </td>
