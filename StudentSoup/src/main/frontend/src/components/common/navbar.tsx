          ...
          {isLogin ?
            <div className="flex sticky">
              <div className="flex flex-col items-center">
                <div id="로그아웃" className='w-[40px] h-[40px] bg-[url("./img/circle_fill_gray.jpg")] bg-cover relative top-[14px] rounded-full border-[1px] border-[#FF4D14] cursor-pointer'></div>
